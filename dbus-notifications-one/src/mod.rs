...
pub trait OrgFreedesktopNotifications {
    ...
    fn notify(&self, app_name: &str, replaces_id: u32, app_icon: &str, summary: &str, body: &str, actions: Vec<&str>, hints: ::std::collections::HashMap<&str, arg::Variant<Box<dyn arg::RefArg>>>, expire_timeout: i32) -> Result<u32, tree::MethodErr>;
}

pub fn org_freedesktop_notifications_server<F, T, D>(factory: &tree::Factory<tree::MTFn<D>, D>, data: D::Interface, f: F) -> tree::Interface<tree::MTFn<D>, D>
where
    D: tree::DataType,
    D::Method: Default,
    ...
    F: 'static + for <'z> Fn(& 'z tree::MethodInfo<tree::MTFn<D>, D>) -> & 'z T,
{
    ...
    let h = move |minfo: &tree::MethodInfo<tree::MTFn<D>, D>| {
        ...
        let d = fclone(minfo);
        let id = d.notify(app_name, replaces_id, app_icon, summary, body, actions, hints, expire_timeout)?;
        let rm = minfo.msg.method_return();
